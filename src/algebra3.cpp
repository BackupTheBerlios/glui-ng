...
vec2 GLUI::operator-(const vec2 &a)
{
    return vec2(-a.n[VX],-a.n[VY]);
}

vec2 GLUI::operator+(const vec2 &a, const vec2& b)
{
...
vec2 GLUI::operator*(const mat3 &a, const vec2 &v)
{
  vec3 av;
...
vec2 GLUI::operator*(const vec2 &v, const mat3 &a)
{
    return a.transpose() * v;
}

vec3 GLUI::operator*(const mat3 &a, const vec3 &v)
{
    vec3 av;
...
vec3 GLUI::operator*(const vec3 &v, const mat3 &a)
{
    return a.transpose() * v;
}
...
vec3 GLUI::operator^(const vec2 &a, const vec2 &b)
{
    return vec3(0.0, 0.0, a.n[VX] * b.n[VY] - b.n[VX] * a.n[VY]);
}

int GLUI::operator==(const vec2 &a, const vec2 &b)
{
    return (a.n[VX] == b.n[VX]) && (a.n[VY] == b.n[VY]);
}
...
vec2 GLUI::min_vec(const vec2 &a, const vec2 &b)
{
    return vec2(MIN(a.n[VX], b.n[VX]), MIN(a.n[VY], b.n[VY]));
}

vec2 GLUI::max_vec(const vec2 &a, const vec2 &b)
{
    return vec2(MAX(a.n[VX], b.n[VX]), MAX(a.n[VY], b.n[VY]));
}

vec2 GLUI::prod(const vec2 &a, const vec2 &b)
{
    return vec2(a.n[VX] * b.n[VX], a.n[VY] * b.n[VY]);
}
...
vec3 GLUI::operator-(const vec3 &a)
{
    return vec3(-a.n[VX],-a.n[VY],-a.n[VZ]);
}

vec3 GLUI::operator+(const vec3 &a, const vec3 &b)
{
...
vec3 GLUI::operator*(const mat4 &a, const vec3 &v)
{
    return a*vec4(v);
}

/*vec3 GLUI::operator*(const vec3 &v, mat4 &a)
{
    return a.transpose()*v;
}*/
...
int GLUI::operator==(const vec3 &a, const vec3 &b)
{
    return (a.n[VX] == b.n[VX]) && (a.n[VY] == b.n[VY]) && (a.n[VZ] == b.n[VZ]);
}
...
vec3 GLUI::min_vec(const vec3 &a, const vec3 &b)
{
    return vec3(
        MIN(a.n[VX], b.n[VX]),
        MIN(a.n[VY], b.n[VY]),
...
vec3 GLUI::max_vec(const vec3 &a, const vec3 &b)
{
    return vec3(
        MAX(a.n[VX], b.n[VX]),
        MAX(a.n[VY], b.n[VY]),
...
vec3 GLUI::prod(const vec3 &a, const vec3 &b)
{
    return vec3(a.n[VX]*b.n[VX], a.n[VY]*b.n[VY], a.n[VZ]*b.n[VZ]);
}
...
vec4 GLUI::operator-(const vec4 &a)
{
    return vec4(-a.n[VX],-a.n[VY],-a.n[VZ],-a.n[VW]);
}

vec4 GLUI::operator+(const vec4 &a, const vec4 &b)
{
    return vec4(
        a.n[VX] + b.n[VX],
        a.n[VY] + b.n[VY],
...
vec4 GLUI::operator*(const mat4 &a, const vec4 &v)
{
    #define ROWCOL(i) \
        a.v[i].n[0]*v.n[VX] + \
        a.v[i].n[1]*v.n[VY] + \
...
vec4 GLUI::operator*(const vec4 &v, const mat4 &a)
{
    return a.transpose()*v;
}
...
int GLUI::operator==(const vec4 &a, const vec4 &b)
{
    return
        (a.n[VX] == b.n[VX]) &&
        (a.n[VY] == b.n[VY]) &&
...
/*ostream& GLUI::operator << (ostream& s, vec4& v)
{ return s << "| " << v.n[VX] << ' ' << v.n[VY] << ' ' << v.n[VZ] << ' '
  << v.n[VW] << " |"; }

istream& GLUI::operator >> (istream& s, vec4& v) {
    vec4    v_tmp;
    char    c = ' ';
...
vec4 GLUI::min_vec(const vec4 &a, const vec4 &b)
{
    return vec4(
        MIN(a.n[VX], b.n[VX]),
        MIN(a.n[VY], b.n[VY]),
...
vec4 GLUI::max_vec(const vec4 &a, const vec4 &b)
{
    return vec4(
        MAX(a.n[VX], b.n[VX]),
        MAX(a.n[VY], b.n[VY]),
...
vec4 GLUI::prod(const vec4 &a, const vec4 &b)
{
    return vec4(
        a.n[VX] * b.n[VX],
        a.n[VY] * b.n[VY],
...
mat3 GLUI::operator-(const mat3 &a)
{
    return mat3(-a.v[0], -a.v[1], -a.v[2]);
}

mat3 GLUI::operator+(const mat3 &a, const mat3 &b)
{
...
int GLUI::operator==(const mat3 &a, const mat3 &b)
{
    return
        (a.v[0] == b.v[0]) &&
        (a.v[1] == b.v[1]) &&
...
/*ostream& GLUI::operator << (ostream& s, mat3& m)
{ return s << m.v[VX] << '\n' << m.v[VY] << '\n' << m.v[VZ]; }

istream& GLUI::operator >> (istream& s, mat3& m) {
    mat3    m_tmp;
...
mat4 GLUI::operator-(const mat4 &a)
{
    return mat4(-a.v[0],-a.v[1],-a.v[2],-a.v[3]);
}

mat4 GLUI::operator+(const mat4 &a, const mat4 &b)
{
    return mat4(
        a.v[0] + b.v[0],
        a.v[1] + b.v[1],
...
int GLUI::operator==(const mat4 &a, const mat4 &b)
{
    return
        (a.v[0] == b.v[0]) &&
        (a.v[1] == b.v[1]) &&
...
/*ostream& GLUI::operator << (ostream& s, mat4& m)
{ return s << m.v[VX] << '\n' << m.v[VY] << '\n' << m.v[VZ] << '\n' << m.v[VW]; }

istream& GLUI::operator >> (istream& s, mat4& m)
{
    mat4    m_tmp;
